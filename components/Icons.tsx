...
import { GlobalStyle, TailwindColors } from '../AppStyles';
import {
    Svg,
    Circle,
    Ellipse,
...
const Icons = {
    ...
    Logo: <Svg style={[GlobalStyle.spacer, GlobalStyle.transparent, IconsStyle.logo]} x="0px" y="0px" height="100%" viewBox="-100 0 850 1000">
        <G>
        <G>
